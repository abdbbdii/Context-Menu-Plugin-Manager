...
class RegistryMenu:
    ...
    def create_command(self, name: str, path: str, command: str, icon_path: str = None) -> None: # me
        """
        ...
        if icon_path is not None: # me
            set_key_value(key_path, 'Icon', icon_path) # me
        ...
        if icon_path is not None: # me
            set_key_value(command_path, 'Icon', icon_path) # me
    ...
    def compile(
        ...
        for item in items:
            ...
            if item.command == None:
                ...
                if item.icon_path is not None: # me
                    self.create_command(item.name, path, new_command, item.icon_path) # me
                else: # me
